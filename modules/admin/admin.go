...
import (
	...
	"github.com/MahdiDjango/GopherGroupBot/modules/sql"
	"github.com/MahdiDjango/GopherGroupBot/modules/texts"
	"github.com/MahdiDjango/GopherGroupBot/modules/utils"
...
func DisableCommands(bot ext.Bot, u *gotgbot.Update, args []string) error {
	...
	if len(args) == 0 {
		text := "این دستور دستورات سفارشی را غیرفعال می کند. لیست دستورات:"
