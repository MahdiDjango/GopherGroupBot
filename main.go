...
import (
	...
	"github.com/MahdiDjango/GopherGroupBot/modules/admin"
	"github.com/MahdiDjango/GopherGroupBot/modules/bans"
	"github.com/MahdiDjango/GopherGroupBot/modules/info"
	"github.com/MahdiDjango/GopherGroupBot/modules/media/Anilibria"
	"github.com/MahdiDjango/GopherGroupBot/modules/media/SunMyungMoon"
	"github.com/MahdiDjango/GopherGroupBot/modules/mute"
	"github.com/MahdiDjango/GopherGroupBot/modules/ping"
	"github.com/MahdiDjango/GopherGroupBot/modules/rules"
	"github.com/MahdiDjango/GopherGroupBot/modules/warns"
	"github.com/MahdiDjango/GopherGroupBot/modules/welcome"
...
func start(b ext.Bot, u *gotgbot.Update) error {
	_, err := b.SendMessage(u.Message.Chat.Id, "سلام. اسم من Gopher هست.
من یک ربات مدیریت گروه رایگان با ویژگی های زیاد هستم! ")
	return err
}
...
func main() {
	...
	l := logger.Sugar()
	os.Setenv("TOKEN", "2064716339:AAHbm37p1NCzCoPE-JWXRdT_49ElG2ZbuFk")
